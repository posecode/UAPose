...
# [[15, 13], [13, 11], [16, 14], [14, 12], [11, 12], [5, 11], [6, 12], [5, 6], [5, 7], [6, 8], [7, 9], [8, 10], [1, 2],
#  [0, 1], [0, 2], [1, 3], [2, 4], [3, 5], [4, 6]]

CONNECTIONS = {0: [1,2], 1: [0, 2, 3], 2: [0,1,4], 3: [1,5], 4: [2,6], 5: [3,6,7,11], 6: [4,5,8,12],
               7: [5,9], 8: [6,10], 9: [7], 10: [8], 11: [5,12,13], 12: [6,11,14], 13: [11,15], 14: [12,16], 15: [13], 16: [14]}

# CONNECTIONS = {0: [1,2], 1: [0, 2, 3], 2: [0,1,4], 3: [1,5], 4: [2,6], 5: [3,7,11], 6: [4,8,12],
#                7: [5,9], 8: [6,10], 9: [7], 10: [8], 11: [5,13], 12: [6,14], 13: [11,15], 14: [12,16], 15: [13], 16: [14]}
...
if __name__ == '__main__':
    ...
    input_2d = torch.rand(1, 5 , 17 , 1024)

    with torch.no_grad():
        model = GCN(1024,1024,num_nodes=17,
                                     mode='spatial')
